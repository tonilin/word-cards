...
role :web, "word-cards.com"                          # Your HTTP server, Apache/etc
role :app, "word-cards.com"                         # This may be the same as your `Web` server
role :db,  "word-cards.com"   , :primary => true # This is where Rails migrations will run
